...
[Original Page](https://leetcode.com/problems/flip-binary-tree-to-match-preorder-traversal/)
...
Our goal is to flip the __least number__ of nodes in the tree so that the voyage of the tree matches the `voyage` we are given.
