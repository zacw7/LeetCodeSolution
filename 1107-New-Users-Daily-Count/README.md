...
[Original Page](https://leetcode.com/problems/new-users-daily-count/)
...
Write an SQL query that reports for every date within at most __90 days__ from today, the number of users that logged in for the first time on that date. Assume today is __2019-06-30__.
