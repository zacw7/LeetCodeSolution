...
[Original Page](https://leetcode.com/problems/profitable-schemes/)
...
How many schemes can be chosen?  Since the answer may be very large, __return it modulo__ `10^9 + 7`.
